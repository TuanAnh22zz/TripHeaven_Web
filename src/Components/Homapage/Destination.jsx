...
const ItemDestination = ({ name, image }) => (
  <div className="">
    <div
      className="max-w-full w-[386] h-[405px] rounded-[20px]"
    ...
    >
      <LayoutContainer className="!px-[0]">
        <div className="text-center">
          ...
          <div className="mt-[30px] mb-[40px] text-[#505050] px-[200px]">
            Khám phá những thành phố tuyệt vời trên thế giới, nơi sự kết hợp
            hoàn hảo giữa kiến trúc, văn hóa đa dạng và cuộc sống sôi động tạo
            nên những trải nghiệm đáng nhớ.
          </div>
        </div>
        <div
          className="
