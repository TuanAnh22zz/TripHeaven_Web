...
const ItemBlog = ({ title, text, image }) => (
  <div className="border-main p-[20px] border-solid border-[3px] rounded-[20px]">
    <img
      src={image}
      alt=""
      className="w-[341px] h-[251px] max-w-full rounded-[20px] mb-[30px]"
    />
    <a href="http://" className="text-[24px] font-[700]">
      {title}
    </a>
    <p className="text-[16px] font-[400] text-[#505050] pt-[10px] pb-[40px]">
      {text}
    </p>
    ...
    <MaterialButton
      variant="contained"
      disableElevation
      className="!rounded-[5px] !bg-main !text-[16px] !font-[700] !py-[8px] !px-[30px] !mt-[10px]"
    >
      Đọc thêm
    </MaterialButton>
  </div>
    ...
    <div className="">
      <LayoutContainer className="!px-[0]">
        <div className="text-center">
          <div className="text-main font-[700] text-[24px] mb-[15px]">
            Blog & Tin tức
          </div>
          <div className="text-black mt-[15px] text-[40px] uppercase font-[700]">
            Tin tức mới nhất
          </div>
          <p className="mt-[30px] mb-[40px] text-[#505050] px-[300px]">
            Khám phá bài viết mới nhất với thông tin nổi bật, các xu hướng mới
            nhất và nội dung hữu ích để giúp bạn cập nhật và được thông tin tức
            thời..
          </p>
        </div>
        <div
