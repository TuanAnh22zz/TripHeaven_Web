      ...
      <LayoutContainer>
        <div className="flex flex-wrap">
          <div className="w-1/2 flex mr-auto">
            <div className="">
              <span className="font-[700] text-[24px] mb-[15px] text-transparent-[capitalize] text-[#4CAF50] ">
                {bannerInfo.sub_title}
              </span>
              <h2 className="mt-[15px] font-[700] text-[64px] text-white uppercase ">
                {bannerInfo.title}
              </h2>
              <p className="text-white leading-[26px] mt-[30px] mb-[40px] pr-[200px]">
                {bannerInfo.text}{" "}
              </p>
              <div className="btn_wrapper">
                <a href="http://">
                  <Button>{bannerInfo.buttonText}</Button>
                </a>
              </div>
            </div>
          </div>
          <div className="w-1/2 flex justify-end items-center mr-auto">
            <div className="info__banner__right">
              <form
                action=""
                className="bg-white border-main border-solid border-[4px] rounded-[5px]"
              >
                ...
                <div className="py-[25px] px-[20px]">
                  <a href="http://">
                    <MaterialButton
                      variant="contained"
                      disableElevation
                      className="py-[15px] px-[0]rounded-[10px] w-[400px] !bg-main"
                    >
                      Tìm Ngay
                    </MaterialButton>
                  </a>
