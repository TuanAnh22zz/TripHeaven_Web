      ...
      <LayoutContainer>
        <div className="flex flex-wrap">
          <div className="w-1/2 flex items-center">
            <div className="">
              <span className="font-[700] text-[24px] mb-[15px] text-transparent-[capitalize] text-white">
                {discoverInfo.sub_title}
              </span>
              <h2 className="mt-[15px] font-[700] text-[40px] uppercase text-white">
                {discoverInfo.title}
              </h2>
              <p className="leading-[26px] mt-[30px] mb-[40px] pr-[200px] text-white">
                {" "}
                {discoverInfo.text}
              </p>
              <div className="btn_wrapper">
                <MaterialButton
                    ...
                    variant="contained"
                    disableElevation
                    className="!rounded-[5px] !bg-white !text-main !text-[16px] !font-[700] !py-[8px] !px-[30px] !mt-[10px]"
                    >
