                        ...
                        <div className="w-3/5 space-y-[60px]">
                            <div className="flex flex-wrap rounded-[20px] solid border-main border-[1px]">
                                ...
                                <div className="px-[50px] py-[40px]">
                                    <a href="" className="text-[30px] font-[700]">10 Sun Hats For Beach Days, Long Hikes, And Everything In Between</a>
                                    <p className="text-[16px] text-gray-500 mt-[10px]">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.</p>
