...
function History () {
    ...
    return (
        ...
        <LayoutContainer>
        <div ref={ref1} className={`mb-[80px] text-center ${view1?"animate-slideTop":"opacity-0"}`}>
        ...
        <div ref={ref2} className={`${view2?"animate-slideTop":"opacity-0"} grid grid-cols-2 grid-rows-3 gap-4 relative`}>
