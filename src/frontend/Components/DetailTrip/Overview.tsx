...
faCirclePlus,faHotel, faBus, faMountain, faCloudSunRain, faUtensils, faLanguage, faClock, faWifi, faChild, faPerson, faHeart, faCalendarDays, faFontAwesome} from '@fortawesome/free-solid-svg-icons'
...
const CalendarDaysIcon = <FontAwesomeIcon icon={faCalendarDays} style={{color: '#4CAF50'}}/>
const MapIcon = <FontAwesomeIcon icon={faMap} style={{color: '#4CAF50'}} />
...
const ClockIcon = <FontAwesomeIcon icon={faFontAwesome} style={{color: '#4CAF50'}}/>
